...
\extrainfo{30 years\tikzmark{end}}
...
\section{Experiences}
\cventry{March 2020 \\to Today}{Qiskit Advocate}{Qiskit community}{}{}{
Advocate for the Qiskit community, opensource contributor for Qiskit projects.
...
Engineer responsible of maintaining an infrastructure on virtual and physical servers. And responsible of the system environment of Linky intervention platform.
\begin{itemize}[topsep=2pt, itemsep=1pt, partopsep=1pt, parsep=1pt]
\item Migration application to a new tool network environment using Ansible
\item Maintaining and developing architecture using Terraform
\item Development of new tools to help internal development
\item Automatization using GitLab CI/CD, Jenkins and Argo tools
\end{itemize}}
\cventry{July 2018\\to July 2022}{System Engineer}{Orange by Capgemini}{Sophia-Antipolis}{France}{
...
\section{Education}
\cventry{2016 -- 2017}{Master 2}{ESAIP Dijon (France)}{IT project management}{}{}
