...
\section{Expériences}
\cventry{Mars 2020 \\à Aujourd'hui}{Qiskit Advocate \& Chargé d'étude en informatique quantique}{Qiskit community}{}{}{
Représentant de la communauté Qiskit, contributeur opensource pour les projets Qiskit. Egalement chargé d'étude en QC pour Altran à but éducatif et de prototypage.
...
\end{itemize}}
\cventry{Juillet 2022\\à Novembre 2022}{Ingénieur infrastructure}{EDF Store and Forecast}{Lyon}{France}{
Ingénieur responsable du maintien d'une infrastructure sur AWS pour le développement de systèmes de gestion d'énergie embarqué.
\begin{itemize}[topsep=2pt, itemsep=1pt, partopsep=1pt, parsep=1pt]
\item Migration d'application depuis une architecture physique sur le cloud AWS via Kubernetes
\item Maintien et developpement de l'architecture AWS via Terraform
\item Developpement de nouveaux outils transverse
\item Automatisation de processus via GitLab CI/CD et les outils Argo
\end{itemize}}
